...
import { FileText, Users, Book, Network, Zap, Shield, BarChart2, Cloud, Sun, Moon } from 'lucide-react'
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-200 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none bg-gradient-radial from-transparent to-gray-100 dark:to-gray-950 opacity-20" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          ...
          >
            ...
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 border border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 rounded-lg font-medium text-gray-700 dark:text-gray-200 transition-all duration-200"
            >
              Watch Demo
            </motion.button>
          </motion.div>
      ...
      <div className="bg-gray-50 dark:bg-gray-800/50 transition-colors duration-200 py-20">
      ...
      >
        ...
        <motion.button 
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="px-8 py-4 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium text-lg transition-all duration-200"
        >
          Start Free Trial
        </motion.button>
      </motion.div>
...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => (
  <motion.div
    ...
    className="p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-red-500 dark:hover:border-red-500 transition-all duration-200 bg-white dark:bg-gray-800/50"
  >
